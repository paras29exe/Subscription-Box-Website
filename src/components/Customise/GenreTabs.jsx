export default function GenreTabs({ genres, selectedGenre, setSelectedGenre }) {
    return (
      <div className="grid grid-cols-2 px-4 sm:grid-cols-4 gap-2 lg:gap-4 mb-4 sticky top-[60px] !z-20 pb-4 pt-4 bg-gradient-to-b from-transparent via-white/70 dark:via-black/70 to-transparent">
        {genres.map((genre) => (
          <button
            key={genre.id}
