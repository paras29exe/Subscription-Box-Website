    ...
    <section className="min-h-screen bg-gradient-to-b  dark:from-black dark:to-gray-900 text-gray-900 dark:text-gray-200 py-20 transition-all">
      ...
      <div className="max-w-6xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
        {genres.map((genre, index) => (
          <SurpriseCard key={index} plansRef={plansRef} genre={genre} index={index} selectedGenre={selectedGenre} handleGenreSelect={handleGenreSelect} />
