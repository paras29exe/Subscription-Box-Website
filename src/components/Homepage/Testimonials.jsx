...
const testimonials = [
  ...
  { name: "Paras Saini", review: "The quality and curation are top-notch—totally worth it!", image: "/me.png" },
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            <div className="flex justify-center mx-auto overflow-hidden bg-slate-200 w-16 rounded-full aspect-square">
              <img src={testimonial.image} alt={testimonial.name} className="w-full mx-auto rounded-full object-cover object-top" />
            </div>
